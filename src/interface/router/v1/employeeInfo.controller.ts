...
export class EmployeeInfoController {
  ...
  @ApiOperation({ summary: '社員情報を取得するAPI', description: 'typeormを利用して、社員情報を取得するAPI' })
  ...
  @ApiOperation({ summary: '社員情報を登録するAPI', description: 'typeormを利用して、社員情報を登録するAPI' })
  ...
  @ApiOperation({ summary: '社員情報を取得するAPI', description: 'sequelizeを利用して、社員情報を取得するAPI' })
  @ApiCommonGetHeaderAndResponses({ status: 200, type: GetEmployeeInfoResponseDataType, isArray: true })
  @Get('/sequelize')
  ...
  @ApiOperation({ summary: '社員情報を登録するAPI', description: 'sequelizeを利用して、社員情報を登録するAPI' })
  @ApiBody({ type: CreateEmployeeInfoType, isArray: true })
  @ApiCommonCreateHeaderAndResponses()
  @Post('/sequelize')
